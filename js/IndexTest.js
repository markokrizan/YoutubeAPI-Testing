...
$(document).ready(function(){
 ...
 function generisiRedKlipova(imeKanala, kontejnerZaNaziv, kontejnerZaRed){
    ...
    function getVids(pid){
        ...
        function(data){
            ...
            $.each(data.items, function(i, item){
                ...
                Ispis(videoThumbnail, videoId, videoTitle, VremePostavljanja, imeKanala, NazivKanala);
    ...
    function Ispis(videoThumbnail, videoId, videoTitle, VremePostavljanja, imeKanala, NazivKanala){
                var pregleda;
                $.get(
                ...
                function(data){
                    $.each(data.items, function(i, item){
                        ...
                        //console.log(pregleda);
                        
                         output = '<div class="col-sm-3  kartica" >'+
                             '<img width = "100%" heigth = "100%" src = "'+ videoThumbnail +'"'+'>'+
                              '</img>'+
                              
                              '<h4 class = "nasloviVidea">' + '<a href = Video.html?VideoId='+videoId+'&VideoTitle='+videoTitle+'>'+ videoTitle +'</a>'+ '</h4>'+
                             '<div class = "podaciOVideu">'+
                              '<hr>'+
                              '<h6 style = "display:inline;">' + VremePostavljanja.substr(0,10) + '</h6>' +
                              '&nbsp;&nbsp;&nbsp;&nbsp;'+
                              '<h6 style = "display:inline;">Pregleda: '+ pregleda +'</h6>'+
                              '</div'+
                            '</div>'
...
/*
Array.prototype.Sortiraj = function(){
    ...
    $.each(arr, function(i, item){       
        ...
        function(data){
            $.each(data.items, function(i, item){
                ...
                //id = item.id;
                //console.log(id);
                brojSubskrajbera = item.statistics.subscriberCount;
                arr2.push(brojSubskrajbera);
                //console.log(brojSubskrajbera);
